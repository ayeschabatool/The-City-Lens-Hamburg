...
crime_2023 as (
  select
    ...
    cast(absolut_2023_txt as integer)    as absolut,
    cast(aufgeklart_2023_txt as integer) as aufgeklart,
...
crime_2024 as (
  select
    ...
    cast(absolut_2024_txt as integer)    as absolut,
    cast(aufgeklart_2024_txt as integer) as aufgeklart,
